  ...
  return (
    <div className="bg-gray-50">
      ...
      <section 
        ...
        style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://picsum.photos/seed/school/1920/1080')` }}
      >
      ...
      <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
              ...
              <Link to="/guru-dan-galeri" className="mt-8 inline-block bg-primary text-white font-bold py-3 px-6 rounded-lg hover:bg-primary-dark transition-colors duration-300">
                  Lihat Semua Galeri
              </Link>
          </div>
      </section>
